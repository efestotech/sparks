...
<?= $this->section('title') ?><?= lang('Sparks.hephaestus_forge') ?><?= $this->endSection() ?>
...
<div class="row">
    ...
    <div class="col-lg-4 col-md-6 mb-4">
        <div class="small-box shadow-sm h-100" style="border-radius: 0; background-color: #fff; border-left: 5px solid var(--hephaestus-gold);">
            <div class="inner">
                <h3 class="font-family-cinzel"><?= $stats['queued'] ?></h3>
            ...
            <div class="icon">
                <i class="fas fa-fire-alt text-warning opacity-25" style="font-size: 50px; position: absolute; right: 15px; top: 15px;"></i>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6 mb-4">
        <div class="small-box shadow-sm h-100" style="border-radius: 0; background-color: #fff; border-left: 5px solid #6f42c1;">
            <div class="inner">
                <h3 class="font-family-cinzel"><?= $stats['scheduled'] ?></h3>
            ...
            <div class="icon">
                <i class="fas fa-clock text-primary opacity-25" style="font-size: 50px; position: absolute; right: 15px; top: 15px;"></i>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6 mb-4">
        <div class="small-box shadow-sm h-100" style="border-radius: 0; background-color: #fff; border-left: 5px solid #28a745;">
            <div class="inner">
                <h3 class="font-family-cinzel"><?= $stats['sent'] ?></h3>
            ...
            <div class="icon">
                <i class="fas fa-paper-plane text-success opacity-25" style="font-size: 50px; position: absolute; right: 15px; top: 15px;"></i>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6 mb-4">
        <div class="small-box shadow-sm h-100" style="border-radius: 0; background-color: #fff; border-left: 5px solid #dc3545;">
            <div class="inner">
                <h3 class="font-family-cinzel"><?= $stats['failed'] ?></h3>
            ...
            <div class="icon">
                <i class="fas fa-times-circle text-danger opacity-25" style="font-size: 50px; position: absolute; right: 15px; top: 15px;"></i>
            </div>
        </div>
    </div>
    ...
    <!-- Active SMTPs -->
    <div class="col-lg-6 col-md-6 mb-4">
        <div class="small-box shadow-sm h-100" style="border-radius: 0; background-color: #fff; border-left: 5px solid var(--greek-blue);">
            <div class="inner">
                <h3 class="font-family-cinzel"><?= $stats['smtp_active'] ?></h3>
            ...
            <div class="icon">
                <i class="fas fa-hammer text-info opacity-25" style="font-size: 50px; position: absolute; right: 15px; top: 15px;"></i>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12 text-center">
        <form action="<?= base_url('worker.php') ?>" method="get" target="_blank">
            ...
            <button type="submit" class="btn btn-primary px-5 py-3 shadow">
                <i class="fas fa-fire mr-1"></i> <?= lang('Sparks.ignite_queue') ?>
            </button>
        </form>
        <p class="text-muted small mt-2"><?= lang('Sparks.worker_help') ?></p>
    </div>
</div>
<?= $this->endSection() ?>
